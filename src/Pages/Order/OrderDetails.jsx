            ...
            <div className="container">
                ...
                <div className="order-overview">
                    <div className="overview-item">
                        ...
                        <p>Placed on: {new Date(orderDetails.createdAt).toLocaleDateString("en-GB", {
                            day: "numeric",
                            month: "short",
                            year: "numeric",
                        })}</p>
                    ...
                    <div className="overview-item">
                        ...
                        <p><strong>Total Price:</strong> ${orderDetails.total.toFixed(2)}</p>
                        <p><strong>Coupon Discount:</strong> ${orderDetails.discountAmount.toFixed(2)}</p>
                ...
                <div className="payment-details">
                    ...
                    <div className="summary-item total">
                        ...
                        <p><strong>${orderDetails.total.toFixed(2)}</strong></p>
                    </div>
                </div>
                ...
                {orderDetails.status !== "Delivered" && (
                    <div className="action-buttons">
                        ...
                        >
                            {orderDetails.status === "Shipped" ? "Cannot Cancel Shipped Order" : "Cancel Order"}
                        </button>
                ...
                <div className="action-buttons">
                    <div></div>
                    <button className="contact-support" onClick={handleContactSupport}>Contact Support</button>
                </div>
            </div>
        </section>
    );
