...
const ProductDetails = () => {
  ...
  const handleAddToCart = () => {
    ...
    if (!selectedSize || !selectedSeamSize) {
      toast.error("Please select a size and seam size before adding to cart.");
      return;
    }
    ...
    <div className="product-detailss">
      <div className="product-details__container">
        ...
        <div className="product-details__info">
          ...
          {/* Seam Size Selector */}
          {/* <div className="selector">
            <label htmlFor="seam-size-selector">Seam Size:</label>
            <select
              id="seam-size-selector"
              value={selectedSeamSize}
              onChange={(e) => setSelectedSeamSize(e.target.value)}
            >
              {product.seamSizes.map((seamSize) => (
                <option key={seamSize} value={seamSize}>
                  {seamSize}
                </option>
              ))}
            </select>
